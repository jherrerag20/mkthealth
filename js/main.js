...
$(document).ready(function() {
    const form = $('form.row.align-items-center');
    form.on('submit', function(event) {
        ...
        inputs.each(function() {
            if ($(this).val().trim() === '') {
                isValid = false;
                $(this).addClass('is-invalid'); // Añadir una clase para marcar el input como inválido
            } else {
                $(this).removeClass('is-invalid'); // Quitar la clase si el input es válido
            }
        });
